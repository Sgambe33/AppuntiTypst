...
Il *Sequence Number* rappresenta la posizione del primo byte dei dati che stanno venendo trasmessi in un segmento. Se il primo pacchetto invia 100 byte iniziando, per semplicità, dal numero di sequenza 1, il pacchetto successivo non avrà sequenza 2, ma sequenza 101.
