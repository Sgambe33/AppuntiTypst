...
#figure(image("images/2025-08-18-15-22-17.png"))
...
#figure(image("images/2025-08-18-15-24-14.png"))
...
#figure(image("images/2025-08-18-15-25-54.png"))

==== Metodi di Accesso ai Registri di un Controllore

#figure(image("images/2025-08-18-15-26-29.png"))
...
1. *I/O Separato in Memoria (o port-mapped I/O)*:
  ...
  #figure(image("images/2025-08-18-15-29-19.png"))
...
#figure(image("images/2025-08-18-15-30-08.png"))
...
#figure(image("images/2025-08-18-15-30-57.png"))
...
#figure(image("images/2025-08-18-15-31-07.png"))
...
#figure(image("images/2025-08-18-15-32-05.png"))
...
#figure(image("images/2025-08-18-15-32-17.png"))
...
#figure(image("images/2025-08-18-15-36-08.png"))
...
#figure(image("images/2025-08-18-15-36-43.png"))
...
#figure(image("images/2025-08-18-15-40-27.png"), caption: "Controllore DMA separato dal controllore del disco")
...
#figure(
  image("images/2025-08-18-15-42-09.png"),
...
#figure(image("images/2025-08-18-15-44-36.png"))
...
- *Protezione dell'I/O*:
  ...
  #figure(image("images/2025-08-18-15-45-11.png"))
...
#figure(image("images/2025-08-18-15-47-03.png"))
...
#figure(image("images/2025-08-18-15-48-51.png"))
...
#figure(image("images/2025-08-18-15-49-28.png"))
...
#figure(image("images/2025-08-18-15-49-58.png"))

==== Settore

#figure(image("images/2025-08-18-15-50-15.png"))
...
#figure(image("images/2025-08-18-15-50-29.png"))
...
#figure(image("images/2025-08-18-15-51-22.png"))
...
#figure(image("images/2025-08-18-15-52-13.png"))
...
#figure(image("images/2025-08-18-15-52-28.png"))
...
- *Criteri di memorizzazione dei dati su disco*:
  ...
  #figure(image("images/2025-08-18-15-55-22.png"))
...
//TODO: Rivedere questi esempi e formattare meglio
...
1. *FCFS (First Come, First Served)*:
  ...
  #figure(image("images/2025-08-18-15-56-38.png"))
...
2. *SSTF (Shortest Seek Time First)*:
  ...
  #figure(image("images/2025-08-18-15-57-26.png"))
  ...
  #figure(image("images/2025-08-18-15-57-52.png"))
...
3. *SCAN (o algoritmo dell'ascensore)*:
  ...
  - *Esempio*: Partendo da `53` e muovendosi verso i cilindri più grandi (fino a 199):
    ...
    #figure(image("images/2025-08-18-15-59-49.png"))
...
4. *C-SCAN (Circular SCAN)*:
  ...
  - *Esempio*: Partendo da `53` e andando verso 199, poi torna a 0:
    ...
    #figure(image("images/2025-08-18-16-00-45.png"))
...
5. *LOOK e C-LOOK*:
  ...
  - *Esempio C-LOOK*: Partendo da `53` e andando verso i cilindri più grandi (fino a `183`, l'ultima richiesta in quella direzione), poi salta direttamente a `14` (la richiesta più piccola), e da lì va a `37`.
    ...
    #figure(image("images/2025-08-18-16-00-57.png"))
